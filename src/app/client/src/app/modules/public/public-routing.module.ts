...
import { DPSDashboardComponent } from './module/dps';
...
const routes: Routes = [
  ...
  {
    path: 'dpsdashboard', component: DPSDashboardComponent, data: {
      telemetry: {
        env: 'public', pageid: 'dpsdashboard', type: 'view', subtype: 'paginate'
      }
    }
  }
];
